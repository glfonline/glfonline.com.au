export type introspection_types = {
	...
	ArticleSortKeys: {
		...
		enumValues: 'AUTHOR' | 'BLOG_TITLE' | 'ID' | 'PUBLISHED_AT' | 'RELEVANCE' | 'TITLE' | 'UPDATED_AT';
	};
	Attribute: {
		kind: 'OBJECT';
		name: 'Attribute';
	...
	BlogSortKeys: {
		name: 'BlogSortKeys';
		enumValues: 'HANDLE' | 'ID' | 'RELEVANCE' | 'TITLE';
	};
	Boolean: unknown;
	Brand: {
		kind: 'OBJECT';
	...
	CardBrand: {
		name: 'CardBrand';
		enumValues: 'AMERICAN_EXPRESS' | 'DINERS_CLUB' | 'DISCOVER' | 'JCB' | 'MASTERCARD' | 'VISA';
	};
	Cart: {
		kind: 'OBJECT';
		name: 'Cart';
	...
	CartAddress: {
		...
		name: 'CartAddress';
		fields: {};
		possibleTypes: 'CartDeliveryAddress';
	};
	CartAddressInput: {
		kind: 'INPUT_OBJECT';
	...
	CartCompletionAction: {
		...
		fields: {};
		possibleTypes: 'CompletePaymentChallenge';
	};
	...
	CartDeliveryGroupType: {
		name: 'CartDeliveryGroupType';
		enumValues: 'ONE_TIME_PURCHASE' | 'SUBSCRIPTION';
	};
	CartDeliveryInput: {
		kind: 'INPUT_OBJECT';
	...
	CartPrepareForCompletionResult: {
		...
		name: 'CartPrepareForCompletionResult';
		fields: {};
		possibleTypes: 'CartStatusNotReady' | 'CartStatusReady' | 'CartThrottled';
	};
	...
	CartSubmitForCompletionResult: {
		...
		name: 'CartSubmitForCompletionResult';
		fields: {};
		possibleTypes: 'SubmitAlreadyAccepted' | 'SubmitFailed' | 'SubmitSuccess' | 'SubmitThrottled';
	};
	CartThrottled: {
		kind: 'OBJECT';
		name: 'CartThrottled';
	...
	CollectionSortKeys: {
		...
		enumValues: 'ID' | 'RELEVANCE' | 'TITLE' | 'UPDATED_AT';
	};
	Color: unknown;
	Comment: {
		kind: 'OBJECT';
	...
	CropRegion: {
		name: 'CropRegion';
		enumValues: 'BOTTOM' | 'CENTER' | 'LEFT' | 'RIGHT' | 'TOP';
	};
	Currency: {
		kind: 'OBJECT';
		name: 'Currency';
	...
	DeliveryAddressValidationStrategy: {
		name: 'DeliveryAddressValidationStrategy';
		enumValues: 'COUNTRY_CODE_ONLY' | 'STRICT';
	};
	DeliveryMethodType: {
		name: 'DeliveryMethodType';
		enumValues: 'LOCAL' | 'NONE' | 'PICKUP_POINT' | 'PICK_UP' | 'RETAIL' | 'SHIPPING';
	};
	DigitalWallet: {
		name: 'DigitalWallet';
		enumValues: 'ANDROID_PAY' | 'APPLE_PAY' | 'GOOGLE_PAY' | 'SHOPIFY_PAY';
	};
	DiscountAllocation: {
		kind: 'OBJECT';
	...
	DiscountApplicationTargetSelection: {
		name: 'DiscountApplicationTargetSelection';
		enumValues: 'ALL' | 'ENTITLED' | 'EXPLICIT';
	};
	DiscountApplicationTargetType: {
		name: 'DiscountApplicationTargetType';
		enumValues: 'LINE_ITEM' | 'SHIPPING_LINE';
	};
	DiscountCodeApplication: {
		kind: 'OBJECT';
	...
	FilterPresentation: {
		name: 'FilterPresentation';
		enumValues: 'IMAGE' | 'SWATCH' | 'TEXT';
	};
	FilterType: {
		name: 'FilterType';
		enumValues: 'BOOLEAN' | 'LIST' | 'PRICE_RANGE';
	};
	FilterValue: {
		kind: 'OBJECT';
		name: 'FilterValue';
	...
	LocationSortKeys: {
		...
		enumValues: 'CITY' | 'DISTANCE' | 'ID' | 'NAME';
	};
	MailingAddress: {
		kind: 'OBJECT';
		name: 'MailingAddress';
	...
	MediaContentType: {
		name: 'MediaContentType';
		enumValues: 'EXTERNAL_VIDEO' | 'IMAGE' | 'MODEL_3D' | 'VIDEO';
	};
	MediaEdge: {
		kind: 'OBJECT';
		name: 'MediaEdge';
	...
	MenuItemResource: {
		...
		name: 'MenuItemResource';
		fields: {};
		possibleTypes: 'Article' | 'Blog' | 'Collection' | 'Metaobject' | 'Page' | 'Product' | 'ShopPolicy';
	};
	MenuItemType: {
		name: 'MenuItemType';
		enumValues:
	...
	MetafieldDeleteErrorCode: {
		...
		enumValues: 'APP_NOT_AUTHORIZED' | 'INVALID_OWNER' | 'METAFIELD_DOES_NOT_EXIST';
	};
	MetafieldDeleteUserError: {
		kind: 'OBJECT';
		name: 'MetafieldDeleteUserError';
	...
	Mutation: {
		...
		fields: {
			...
			shopPayPaymentRequestSessionCreate: {
				name: 'shopPayPaymentRequestSessionCreate';
				type: {
					kind: 'OBJECT';
			...
			shopPayPaymentRequestSessionSubmit: {
				name: 'shopPayPaymentRequestSessionSubmit';
				type: {
					kind: 'OBJECT';
	...
	Order: {
		...
		fields: {
			...
			currentTotalShippingPrice: {
				name: 'currentTotalShippingPrice';
				type: {
					kind: 'NON_NULL';
					name: never;
					ofType: {
	...
	OrderCancelReason: {
		name: 'OrderCancelReason';
		enumValues: 'CUSTOMER' | 'DECLINED' | 'FRAUD' | 'INVENTORY' | 'OTHER' | 'STAFF';
	};
	OrderConnection: {
		kind: 'OBJECT';
		name: 'OrderConnection';
	...
	OrderFinancialStatus: {
		name: 'OrderFinancialStatus';
		enumValues: 'AUTHORIZED' | 'PAID' | 'PARTIALLY_PAID' | 'PARTIALLY_REFUNDED' | 'PENDING' | 'REFUNDED' | 'VOIDED';
	};
	...
	OrderSortKeys: {
		name: 'OrderSortKeys';
		enumValues: 'ID' | 'PROCESSED_AT' | 'RELEVANCE' | 'TOTAL_PRICE';
	};
	Page: {
		kind: 'OBJECT';
		name: 'Page';
	...
	PredictiveSearchType: {
		...
		enumValues: 'ARTICLE' | 'COLLECTION' | 'PAGE' | 'PRODUCT' | 'QUERY';
	};
	PreferenceDeliveryMethodType: {
		name: 'PreferenceDeliveryMethodType';
		enumValues: 'PICKUP_POINT' | 'PICK_UP' | 'SHIPPING';
	};
	PriceRangeFilter: {
		kind: 'INPUT_OBJECT';
	...
	PricingValue: {
		...
		name: 'PricingValue';
		fields: {};
		possibleTypes: 'MoneyV2' | 'PricingPercentageValue';
	};
	Product: {
		kind: 'OBJECT';
		name: 'Product';
		fields: {
			...
			encodedVariantAvailability: {
				name: 'encodedVariantAvailability';
				type: {
					kind: 'SCALAR';
					name: 'String';
					ofType: null;
			...
			selectedOrFirstAvailableVariant: {
				name: 'selectedOrFirstAvailableVariant';
				type: {
					kind: 'OBJECT';
					name: 'ProductVariant';
					ofType: null;
	...
	ProductCollectionSortKeys: {
		...
		enumValues: 'BEST_SELLING' | 'COLLECTION_DEFAULT' | 'CREATED' | 'ID' | 'MANUAL' | 'PRICE' | 'RELEVANCE' | 'TITLE';
	};
	ProductConnection: {
		kind: 'OBJECT';
		name: 'ProductConnection';
	...
	ProductImageSortKeys: {
		...
		enumValues: 'CREATED_AT' | 'ID' | 'POSITION' | 'RELEVANCE';
	};
	ProductMediaSortKeys: {
		name: 'ProductMediaSortKeys';
		enumValues: 'ID' | 'POSITION' | 'RELEVANCE';
	};
	ProductOption: {
		kind: 'OBJECT';
		name: 'ProductOption';
	...
	ProductRecommendationIntent: {
		...
		enumValues: 'COMPLEMENTARY' | 'RELATED';
	};
	ProductSortKeys: {
	...
	ProductVariantSortKeys: {
		...
		enumValues: 'ID' | 'POSITION' | 'RELEVANCE' | 'SKU' | 'TITLE';
	};
	PurchasingCompany: {
		kind: 'OBJECT';
		name: 'PurchasingCompany';
	...
	SearchResultItem: {
		...
		fields: {};
		possibleTypes: 'Article' | 'Page' | 'Product';
	};
	...
	SearchSortKeys: {
		name: 'SearchSortKeys';
		enumValues: 'PRICE' | 'RELEVANCE';
	};
	SearchType: {
		name: 'SearchType';
		enumValues: 'ARTICLE' | 'PAGE' | 'PRODUCT';
	};
	SearchUnavailableProductsType: {
		name: 'SearchUnavailableProductsType';
		enumValues: 'HIDE' | 'LAST' | 'SHOW';
	};
	SearchableField: {
	...
	SellingPlanBillingPolicy: {
		...
		name: 'SellingPlanBillingPolicy';
		fields: {};
		possibleTypes: 'SellingPlanRecurringBillingPolicy';
	};
	...
	SellingPlanCheckoutChargeType: {
		name: 'SellingPlanCheckoutChargeType';
		enumValues: 'PERCENTAGE' | 'PRICE';
	};
	SellingPlanCheckoutChargeValue: {
		kind: 'UNION';
		name: 'SellingPlanCheckoutChargeValue';
		fields: {};
		possibleTypes: 'MoneyV2' | 'SellingPlanCheckoutChargePercentageValue';
	};
	...
	SellingPlanDeliveryPolicy: {
		...
		name: 'SellingPlanDeliveryPolicy';
		fields: {};
		possibleTypes: 'SellingPlanRecurringDeliveryPolicy';
	};
	SellingPlanEdge: {
		kind: 'OBJECT';
		name: 'SellingPlanEdge';
	...
	ShopPayInstallmentsLoan: {
		name: 'ShopPayInstallmentsLoan';
		enumValues: 'INTEREST' | 'SPLIT_PAY' | 'ZERO_PERCENT';
	};
	ShopPayInstallmentsPricing: {
		kind: 'OBJECT';
		name: 'ShopPayInstallmentsPricing';
	...
	ShopPayPaymentRequest: {
		...
		fields: {
			...
			selectedDeliveryMethodType: {
				name: 'selectedDeliveryMethodType';
				type: {
					kind: 'NON_NULL';
					name: never;
					ofType: {
	...
	SitemapType: {
		name: 'SitemapType';
		enumValues: 'ARTICLE' | 'BLOG' | 'COLLECTION' | 'METAOBJECT' | 'PAGE' | 'PRODUCT';
	};
	StoreAvailability: {
		kind: 'OBJECT';
		name: 'StoreAvailability';
	...
	UnitPriceMeasurementMeasuredType: {
		name: 'UnitPriceMeasurementMeasuredType';
		enumValues: 'AREA' | 'LENGTH' | 'VOLUME' | 'WEIGHT';
	};
	UnitPriceMeasurementMeasuredUnit: {
		name: 'UnitPriceMeasurementMeasuredUnit';
		enumValues: 'CL' | 'CM' | 'G' | 'KG' | 'L' | 'M' | 'M2' | 'M3' | 'MG' | 'ML' | 'MM';
	};
	UnitSystem: {
		name: 'UnitSystem';
		enumValues: 'IMPERIAL_SYSTEM' | 'METRIC_SYSTEM';
	};
	...
	UserErrorsShopPayPaymentRequestSessionUserErrorsCode: {
		name: 'UserErrorsShopPayPaymentRequestSessionUserErrorsCode';
		enumValues: 'IDEMPOTENCY_KEY_ALREADY_USED' | 'PAYMENT_REQUEST_INVALID_INPUT' | 'PAYMENT_REQUEST_NOT_FOUND';
	};
	VariantOptionFilter: {
		kind: 'INPUT_OBJECT';
		name: 'VariantOptionFilter';
	...
	WeightUnit: {
		name: 'WeightUnit';
		enumValues: 'GRAMS' | 'KILOGRAMS' | 'OUNCES' | 'POUNDS';
	};
};
