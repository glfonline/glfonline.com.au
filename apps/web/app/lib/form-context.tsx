...
type TextFieldFieldProps = Omit<TextFieldProps, FieldBound> & { required?: boolean };

type TextAreaFieldProps = Omit<TextAreaProps, FieldBound> & { required?: boolean };
...
function FormTextArea({ required, ...props }: TextAreaFieldProps) {
	const field = useFieldContext<string>();
	return (
		<TextArea
			{...props}
