		...
		>
			<div className="min-w-0 flex-1">
				{hasPrevPage && (
					<button
						type="button"
						className="inline-flex h-10 items-center rounded-md border border-gray-300 bg-white px-4 hover:bg-gray-100 focus:border-pink-600 focus:outline-hidden focus:ring-2 focus:ring-pink-600/25 focus:ring-offset-1 focus:ring-offset-pink-600"
						onClick={() => {
							navigate(-1);
						}}
					>
